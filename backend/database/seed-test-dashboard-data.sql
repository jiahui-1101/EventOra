...
INSERT INTO tickets (registration_id, ticket_code, qr_token, status) VALUES
    (1, 'EO-TEST-0001', 'TEST-QR-TOKEN-PLACEHOLDER-0001', 'used'),
    (2, 'EO-TEST-0002', 'TEST-QR-TOKEN-PLACEHOLDER-0002', 'active');
